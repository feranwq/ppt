...
build-all: fmt vet
	...
	CGO_ENABLED=0 GOOS=linux GOARCH=arm64 go build -a -o $(OUTPUT_DIR)/ppt_linux_arm64 .
	CGO_ENABLED=0 GOOS=darwin GOARCH=arm64 go build -a -o $(OUTPUT_DIR)/ppt_darwin_arm64 .
